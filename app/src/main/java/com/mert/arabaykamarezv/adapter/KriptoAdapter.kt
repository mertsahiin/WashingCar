...
import com.mert.arabaykamarezv.databinding.RowLayoutBinding
import com.mert.arabaykamarezv.model.CryptoModel

class KriptoAdapter (private val cryptoList : ArrayList<CryptoModel>, private val listener : Listener) : RecyclerView.Adapter<KriptoAdapter.RowHolder>() {
